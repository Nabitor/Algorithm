...
'''
问题描述：In LLP world, there is a hero called Teemo and his attacking can make his enemy Ashe be in poisoned condition.
...
class Solution(object):
    def findPoisonedDuration(self, timeSeries, duration):
        ...
        for index in range(1,len(timeSeries)):
            total_time += timeSeries[index] - timeSeries[index-1] if timeSeries[index] - timeSeries[index-1] < duration else duration
